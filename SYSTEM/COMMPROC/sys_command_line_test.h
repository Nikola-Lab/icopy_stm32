...
#ifndef __SYS_COMMAND_LINE_TEST_H
#define __SYS_COMMAND_LINE_TEST_H
...
#define CLI_HISTORY         FALSE                    /* history command enable/disable */
...
#define USART_INIT(baud)    uart_init(baud)         /* usart init. */
